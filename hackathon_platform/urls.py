...
urlpatterns = [
    ...
    path('i18n/setlang/', set_language_view, name='set_language'), # <--- Тил алмаштириш учун URL
    ...
    path('api/results/', judging_views.public_results_api_view, name='public_results_api'),
    path('api/team-details/<int:team_id>/', judging_views.team_evaluation_details_api_view, name='team_evaluation_details_api'),
]
...
urlpatterns += i18n_patterns(
    ...
    path('qr/', judging_views.qr_code_view, name='qr_code'),
